...
``` ascii-art
                      ...
                      ┌────────────────┴────────────────┐
                      |                                 |
             Port 443 (websecure)            Port 443 (websecure)
                      |                                 |
       Host: mastodon.homeserver.localnet  Host: mastodon.homeserver.localnet
                      |                      Path: /api/v1/streaming
                      v                                 v
          ┌────────────────────────────────────────────────────┐
          │              MASTODON POD (localhost)              │
          │                                                    │
          │  ┌─────────────────┐        ┌─────────────────┐    │
          │  │   WEB           │        │   STREAMING     │    │
          │  │   (Rails)       │        │   (Node.js)     │    │
          ...
          │                                                    │
          │  [Persistent Volumes]                              │
          │  - mastodon-db (PostgreSQL data)                   │
          │  - mastodon-valkey (Valkey/Redis data)             │
          │  - mastodon-pubsys (Public system files)           │
          └────────────────────────────────────────────────────┘
```
