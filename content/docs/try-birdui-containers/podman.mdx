...
description: 'Mementomori.social runs BirdUI theme for mastodon. If you want to try out what it looks like in your environement, or develop or perhaps switch using it, there is containerized way to easily (?) do so. It is described in this doc.'
---
