---
title: 'Server tech specs'
description: 'Mementomori.social consists of many bits and pieces. This technical page is meant to tell you all about that.'
---
...
<Tabs items={['mastodon-sidekiq-1-default@.service']}>

<Tab value="mastodon-sidekiq-1-default@.service">

```ini title="mastodon-sidekiq-1-default@.service"
[Unit]
...
<Tabs items={['User: root', 'User: mastodon']}>
