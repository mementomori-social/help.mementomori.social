---
title: 'Why Mastodon?'
description: 'Say hello to a healthier social media! Mastodon is way better than Twitter, Threads and Bluesky combined. Why? Well, you''ve come to the right place for that information.'
---

![Social networking that's not for sale. Your home feed should be filled with what matters to you most, not what a corporation thinks you should see. Radically different social media, back in the hands of the people.](/images/image-15.png)
...
![Fediverse statistics: Software User Distribution   Mastodon 79.1%   Misskey 4.6%   Lemmy 3.5%   PeerTube 3.1%   Pixelfed 1.6%   Microdotblog 1.2%   Pleroma 1.1%   Writefreely 1.0%   WordPress 0.7%   Other 4.1%](/images/fedidb.org_.png)

_[FediDB.org](https://fedidb.org/) statistics_
